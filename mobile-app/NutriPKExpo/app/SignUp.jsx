...
const styles = StyleSheet.create({
  container: {
    ...
    backgroundColor: "#FFF3EC",paddingHorizontal: 14,paddingTop: 8,
    paddingBottom: 14,
  },
  backButton: {
    position: "absolute",
  ...
  card: {
    ...
    shadowOpacity: 0.08,
    shadowRadius: 8,  elevation: 3, alignItems: "center", marginBottom: 12,
  },
  cardTop: {
    width: "100%",
    padding: 18,
  ...
  labelText: {
    color: "#0e4f11ff",
    fontSize: 18, marginLeft: 6, marginBottom: 4,
  },
  inputBox: {
    width: "100%",
    height: 48,
